...
public class Navbar extends JPanel {
    ...
    private JButton createIconButton(String iconPath, String buttonType) {
        ...
        switch (buttonType) {
            case "home":
                button.addActionListener(e -> App.showPanel("Home"));
                break;
            case "explore":
                button.addActionListener(e -> App.showPanel("Explore"));
                break;
            case "add":
                button.addActionListener(e -> App.showPanel("Image Upload"));
                break;
            case "notification":
                button.addActionListener(e -> App.showPanel("Notifications"));
                break;
            case "profile":
                button.addActionListener(e -> App.showPanel("Profile"));
                break;
        }
